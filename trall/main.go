...
func main() {
	for _, type_ := range []gobench.SubBenchType{
		gobench.GoKerNonBlocking,
		gobench.GoKerBlocking,
		gobench.GoRealNonBlocking,
		gobench.GoRealBlocking,
	} {
